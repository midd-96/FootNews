...
func (x *LoginUserRequest) GetHashPassword() string {
	if x != nil {
...
func (x *LoginUserReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginUserReponse) ProtoMessage() {}

func (x *LoginUserReponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_login_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginUserReponse.ProtoReflect.Descriptor instead.
func (*LoginUserReponse) Descriptor() ([]byte, []int) {
	return file_rpc_login_user_proto_rawDescGZIP(), []int{1}
}

func (x *LoginUserReponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *LoginUserReponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x10, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x68, 0x61, 0x73, 0x68, 0x50, 0x61, 0x73,
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x46, 0x0a, 0x10, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73, 0x65,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x0f, 0x5a,
	0x0d, 0x4e, 0x65, 0x77, 0x73, 0x41, 0x70, 0x70, 0x41, 0x70, 0x69, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	...
	(*LoginUserReponse)(nil), // 1: pb.LoginUserReponse
	(*User)(nil),             // 2: pb.User
}
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserReponse.user:type_name -> pb.User
